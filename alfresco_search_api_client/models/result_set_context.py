...
class ResultSetContext(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["consistency", "request", "facetQueries", "facetsFields", "facets", "spellcheck"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.facets_fields:
            for _item in self.facets_fields:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "consistency": ResponseConsistency.from_dict(obj.get("consistency")) if obj.get("consistency") is not None else None,
            "request": SearchRequest.from_dict(obj.get("request")) if obj.get("request") is not None else None,
            "facetQueries": [ResultSetContextFacetQueriesInner.from_dict(_item) for _item in obj.get("facetQueries")] if obj.get("facetQueries") is not None else None,
            "facetsFields": [ResultBuckets.from_dict(_item) for _item in obj.get("facetsFields")] if obj.get("facetsFields") is not None else None,
            "facets": [GenericFacetResponse.from_dict(_item) for _item in obj.get("facets")] if obj.get("facets") is not None else None,
            "spellcheck": [ResultSetContextSpellcheckInner.from_dict(_item) for _item in obj.get("spellcheck")] if obj.get("spellcheck") is not None else None
        })
        return _obj
