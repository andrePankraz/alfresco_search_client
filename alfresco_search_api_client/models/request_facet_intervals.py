...
class RequestFacetIntervals(BaseModel):
    ...
    Facet Intervals
    """ # noqa: E501
    sets: Optional[List[RequestFacetSet]] = Field(default=None, description="Sets the intervals for all fields.")
    intervals: Optional[List[RequestFacetIntervalsIntervalsInner]] = Field(default=None, description="Specifies the fields to facet by interval.")
    __properties: ClassVar[List[str]] = ["sets", "intervals"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "sets": [RequestFacetSet.from_dict(_item) for _item in obj.get("sets")] if obj.get("sets") is not None else None,
            "intervals": [RequestFacetIntervalsIntervalsInner.from_dict(_item) for _item in obj.get("intervals")] if obj.get("intervals") is not None else None
        })
        return _obj
