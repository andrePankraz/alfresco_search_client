...
class RequestFacetFields(BaseModel):
    ...
    """ # noqa: E501
    facets: Optional[List[RequestFacetField]] = Field(default=None, description="Define specifc fields on which to facet (adds SOLR facet.field and f.<field>.facet.* options) ")
    __properties: ClassVar[List[str]] = ["facets"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "facets": [RequestFacetField.from_dict(_item) for _item in obj.get("facets")] if obj.get("facets") is not None else None
        })
        return _obj
