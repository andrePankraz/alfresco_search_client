...
class RequestStats(BaseModel):
    ...
    """ # noqa: E501
    field: Optional[StrictStr] = Field(default=None, description="The stats field")
    ...
    __properties: ClassVar[List[str]] = ["field", "label", "min", "max", "sum", "countValues", "missing", "mean", "stddev", "sumOfSquares", "distinctValues", "countDistinct", "cardinality", "cardinalityAccuracy", "excludeFilters", "percentiles"]
