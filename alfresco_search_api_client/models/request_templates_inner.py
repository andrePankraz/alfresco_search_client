...
class RequestTemplatesInner(BaseModel):
    """
    RequestTemplatesInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The template name")
    template: Optional[StrictStr] = Field(default=None, description="The template")
