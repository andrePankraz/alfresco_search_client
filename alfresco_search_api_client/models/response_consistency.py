...
class ResponseConsistency(BaseModel):
    ...
    """ # noqa: E501
    last_tx_id: Optional[StrictInt] = Field(default=None, description="The id of the last indexed transaction", alias="lastTxId")
    __properties: ClassVar[List[str]] = ["lastTxId"]
