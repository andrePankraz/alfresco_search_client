...
class SearchRequest(BaseModel):
    ...
    include: Optional[List[StrictStr]] = Field(default=None, description="Returns additional information about the node. The following optional fields can be requested:  * properties  * aspectNames  * path  * isLink  * allowableOperations  * association  * isFavorite ")
    ...
    __properties: ClassVar[List[str]] = ["query", "paging", "include", "includeRequest", "fields", "sort", "templates", "defaults", "localization", "filterQueries", "facetQueries", "facetFields", "facetIntervals", "pivots", "stats", "spellcheck", "scope", "limits", "highlight", "ranges"]
    ...
    def include_validate_enum(cls, value):
        ...
        for i in value:
            if i not in ('allowableOperations', 'aspectNames', 'isLink', 'isLocked', 'path', 'properties', 'isFavorite'):
                raise ValueError("each list item must be one of ('allowableOperations', 'aspectNames', 'isLink', 'isLocked', 'path', 'properties', 'isFavorite')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.filter_queries:
            for _item in self.filter_queries:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.facet_queries:
            for _item in self.facet_queries:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "query": RequestQuery.from_dict(obj.get("query")) if obj.get("query") is not None else None,
            "paging": RequestPagination.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
            "include": obj.get("include"),
            "includeRequest": obj.get("includeRequest") if obj.get("includeRequest") is not None else False,
            "fields": obj.get("fields"),
            "sort": [RequestSortDefinitionInner.from_dict(_item) for _item in obj.get("sort")] if obj.get("sort") is not None else None,
            "templates": [RequestTemplatesInner.from_dict(_item) for _item in obj.get("templates")] if obj.get("templates") is not None else None,
            "defaults": RequestDefaults.from_dict(obj.get("defaults")) if obj.get("defaults") is not None else None,
            "localization": RequestLocalization.from_dict(obj.get("localization")) if obj.get("localization") is not None else None,
            "filterQueries": [RequestFilterQueriesInner.from_dict(_item) for _item in obj.get("filterQueries")] if obj.get("filterQueries") is not None else None,
            "facetQueries": [RequestFacetQueriesInner.from_dict(_item) for _item in obj.get("facetQueries")] if obj.get("facetQueries") is not None else None,
            "facetFields": RequestFacetFields.from_dict(obj.get("facetFields")) if obj.get("facetFields") is not None else None,
            "facetIntervals": RequestFacetIntervals.from_dict(obj.get("facetIntervals")) if obj.get("facetIntervals") is not None else None,
            "pivots": [RequestPivot.from_dict(_item) for _item in obj.get("pivots")] if obj.get("pivots") is not None else None,
            "stats": [RequestStats.from_dict(_item) for _item in obj.get("stats")] if obj.get("stats") is not None else None,
            "spellcheck": RequestSpellcheck.from_dict(obj.get("spellcheck")) if obj.get("spellcheck") is not None else None,
            "scope": RequestScope.from_dict(obj.get("scope")) if obj.get("scope") is not None else None,
            "limits": RequestLimits.from_dict(obj.get("limits")) if obj.get("limits") is not None else None,
            "highlight": RequestHighlight.from_dict(obj.get("highlight")) if obj.get("highlight") is not None else None,
            "ranges": [RequestRange.from_dict(_item) for _item in obj.get("ranges")] if obj.get("ranges") is not None else None
        })
        return _obj
